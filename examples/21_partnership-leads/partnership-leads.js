...
/**
 * Verifies a coaching firm contact using a nested LLM call.
 * In production this would hit Apollo, LinkedIn, or a CRM API;
 * here we lean on the model's training data to keep the example
 * dependency-free.
 */
...
/**
 * Researches a firm's coaching methodology, client profile, and
 * tech-readiness signals using a nested LLM call.
 */
...
/**
 * Scores a firm on the iGrow partnership fit rubric using a nested
 * LLM call. Rubric: Methodology alignment 30%, Client overlap 30%,
 * Firm size 20%, Tech-forward 20%.
 */
...
/**
 * Packages a verified, enriched lead for the Email Personalization agent.
 * Generates a segment-specific hook for the outreach email.
 */
...
/**
 * Runs the Partnership Leads agent for a batch of incoming leads.
 */
