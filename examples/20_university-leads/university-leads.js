...
/**
 * Verifies a university contact's existence and currency using a nested
 * LLM call. In production this would hit a people-data API (Apollo, Clay,
 * LinkedIn); here we use the model's training data to keep the example
 * dependency-free.
 */
...
/**
 * Deep-researches a specific university program to surface personalization
 * hooks for iGrow outreach. Uses a nested LLM call; a production version
 * would combine web search, the school's website, and news APIs.
 */
...
/**
 * Assigns P1/P2/P3 priority based on institution size, program type, and
 * signal strength. Uses a nested LLM call with strict priority rules.
 */
...
/**
 * Packages a verified, enriched lead into a structured handoff record for
 * the Email Personalization agent. Ensures all required fields are present
...
/**
 * Runs the University Leads agent for a batch of incoming leads.
 */
